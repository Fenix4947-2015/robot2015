...
public class Conveyor extends Subsystem {
	...
	private DigitalInput limitSwitchLeft = new DigitalInput(3);
	private DigitalInput limitSwitchRight = new DigitalInput(2);
	private Solenoid greenLight = new Solenoid(2);
